            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    ...
                    buttons=[
                        ...
                        [
                            custom.Button.url("Sᴜᴘᴘᴏʀᴛ", url="https://t.me/Lutpansupportgrp"),
                        ],
                    ],
                    link_preview=False,
                )
...
""")
        ...
        LOGS.info(
            f"KALO BOT LU NGECRASH, KLIK SAVE YANG DI POJOK KANAN BAWAH DAN KIRIM KE @lutpansupport� TAG @admin » Info By: Lutpan-Userbot {BOT_VER}")
